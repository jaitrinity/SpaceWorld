...
export class LocationComponent implements OnInit {
  ...
  constructor(private router: Router,private sharedService : SharedService,
    ...
    private datePipe : DatePipe) { 
      ...
      this.layoutComponent.setPageTitle("Operational");
    }
  ...
  ngOnInit() {
    ...
    // this.getAllList();
    if(this.loginEmpRoleId == this.spaceworldEmpRoleId)
  ...
  submitLocData(){
    ...
    else if(this.loginEmpRoleId == this.spaceworldEmpRoleId && this.rfiDate == ""){
  ...
  downloadFormat(){
    let link = "http://trinityapplab.in/SpaceTeleinfra/files/uploadFormat/Location_Upload.xlsx";
    window.open(link);
  }
  ...
  editLocationData(){
    ...
    else if(this.loginEmpRoleId == this.spaceworldEmpRoleId && this.editRfiDate == ""){
      this.toastr.warning("please enter RFI date","Alert !",{timeOut : this.alertFadeoutTime});
      return ;
    }
